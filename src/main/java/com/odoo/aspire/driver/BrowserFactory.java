package com.odoo.aspire.driver;

import com.odoo.aspire.exceptions.HeadlessNotSupportedException;
...
public enum BrowserFactory {
    ...
    CHROME {
        ...
        private ChromeOptions getOptions() {
            ...
            chromeOptions.setHeadless(AppConfigManager.configuration().headless());
        ...
        private FirefoxOptions getOptions() {
            ...
            firefoxOptions.setHeadless(AppConfigManager.configuration().headless());
        ...
        private EdgeOptions getOptions() {
            ...
            edgeOptions.setHeadless(AppConfigManager.configuration().headless());
        ...
        private SafariOptions getOptions() {
            ...
            if (TRUE.equals(AppConfigManager.configuration().headless()))
